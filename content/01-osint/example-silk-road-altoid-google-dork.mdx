...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`example`  ·  Level 1  ·  osint · google-dorking · silk-road · case-study · attribution</span>
