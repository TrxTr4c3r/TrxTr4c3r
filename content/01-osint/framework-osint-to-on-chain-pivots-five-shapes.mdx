...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`framework`  ·  Level 2  ·  osint · pivots · attribution · phishing-kits · deployer-history · corroboration</span>
