...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`concept`  ·  Level 2  ·  drainer-kits · pattern-recognition · inferno · attribution · cash-out · fingerprints</span>
