...
## Related
[Temporal Analysis to Defeat Obfuscation](/kb/02-tracing/tactic-temporal-analysis-to-defeat-obfuscation), [Breaking Obfuscation: Five-Part Strategy](/kb/04-laundering-obfuscation/framework-breaking-obfuscation-five-part-strategy), [Surface-Level Fast Wins](/kb/06-casework-method/checklist-surface-level-fast-wins), [Crypto Crime Typology Catalogue](/kb/06-casework-method/checklist-crypto-crime-typology-catalogue), [Identify the Predicate Typology First](/kb/06-casework-method/principle-identify-predicate-typology-first)
