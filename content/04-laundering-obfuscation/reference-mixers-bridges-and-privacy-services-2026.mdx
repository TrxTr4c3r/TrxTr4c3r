...
| FixedFloat, ChangeNOW and peers | Custodial no-KYC swap | **Off-chain order id only** | The service's order-lookup API | Moderate via amount and timing, or the order id |
