...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`checklist`  ·  Level reference  ·  mixers · red-flags · transaction-monitoring · aml · indicators</span>
