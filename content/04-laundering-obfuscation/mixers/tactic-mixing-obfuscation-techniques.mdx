...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`tactic`  ·  Level reference  ·  mixers · obfuscation · denomination-splitting · stealth-addresses · multi-layer-mixing</span>
