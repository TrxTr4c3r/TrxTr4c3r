...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`example`  ·  Level 2  ·  case-study · tornado-cash · mixers · behavioural-matching · address-reuse · attribution</span>
