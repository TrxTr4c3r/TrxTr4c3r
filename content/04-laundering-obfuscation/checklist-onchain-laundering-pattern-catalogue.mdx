...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`checklist`  ·  Level reference  ·  money-laundering · on-chain-patterns · detection · transaction-shapes · checklist</span>
