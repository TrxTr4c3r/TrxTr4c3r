...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`principle`  ·  Level reference  ·  money-laundering · corroboration · evidence · off-chain · principle</span>
