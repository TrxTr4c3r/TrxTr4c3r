...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`caution`  ·  Level 2  ·  monero · privacy-coins · attribution-limits · credibility · osint-pivot</span>
