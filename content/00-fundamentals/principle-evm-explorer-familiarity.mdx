...
## Related
[Reading an EVM Transaction](/kb/00-fundamentals/concept-reading-an-evm-transaction) · [Address View vs Contract View on a Block Explorer](/kb/00-fundamentals/concept-address-view-vs-contract-view) · [Bitcoin UTXO and Change Addresses](/kb/00-fundamentals/concept-bitcoin-utxo-change)
