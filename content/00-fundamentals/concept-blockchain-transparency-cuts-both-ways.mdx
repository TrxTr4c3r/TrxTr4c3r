...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`concept`  ·  Level basics  ·  blockchain · transparency · pseudonymity · public-ledger · attribution · crypto-crime</span>
