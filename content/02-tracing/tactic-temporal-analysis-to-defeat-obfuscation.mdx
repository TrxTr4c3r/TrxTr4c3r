...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`tactic`  ·  Level 2  ·  obfuscation · temporal-analysis · timing · automation · timezone · attribution</span>
