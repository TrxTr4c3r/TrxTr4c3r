...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`concept`  ·  Level 2  ·  evm · erc-20 · approvals · drainer · victim-remediation · revoke</span>
