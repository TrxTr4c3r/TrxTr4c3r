...
## Related
[EVM Event Logs & Decoding Calldata](/kb/02-tracing/tactic-evm-event-logs-and-decoding-calldata), [EVM Proxies: Read the Right Source](/kb/02-tracing/caution-evm-proxies-read-the-right-source), [View a Wallet's Exposure with impersonator.xyz](/kb/03-attribution-clustering/tactic-view-a-wallets-exposure-with-impersonator-xyz), [Crypto Crime Typology Catalogue](/kb/06-casework-method/checklist-crypto-crime-typology-catalogue), [Identify the Predicate Typology First](/kb/06-casework-method/principle-identify-predicate-typology-first)
