...
## Related
[Transaction Graph Analysis (TGA)](/kb/02-tracing/tactic-transaction-graph-analysis) · [Address Clustering (Common-Input-Ownership Heuristic)](/kb/03-attribution-clustering/tactic-address-clustering-cioh) · [Taint Analysis (Taint Tracing)](/kb/02-tracing/tactic-taint-analysis) · [Exchange / VASP KYC Correlation](/kb/03-attribution-clustering/tactic-vasp-kyc-correlation) · [Crypto Cost-Basis Methods: FIFO vs HIFO vs LIFO](/kb/00-fundamentals/concept-crypto-cost-basis-methods)
