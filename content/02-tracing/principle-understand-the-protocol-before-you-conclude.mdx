...
## Related
[Mint-Style Bridges: Pivot to Counterparty-Graph Analysis](/kb/02-tracing/tactic-mint-style-bridges-pivot-to-counterparty-graph-analysis) · [Tornado Cash to RenBTC Cross-Chain Laundering Pattern](/kb/04-laundering-obfuscation/concept-tornado-renbtc-laundering-pattern) · [Decoding a Cross-Chain Destination Address from Input Data](/kb/02-tracing/tactic-decode-cross-chain-destination-address) · [Separate On-Chain Fact from Analytical Inference](/kb/05-evidence-legal/principle-separate-on-chain-fact-from-inference) · [Protocol Housekeeping vs Incident](/kb/02-tracing/tactic-protocol-housekeeping-vs-incident) · [THORChain Vault Churn and Asgard Migration](/kb/02-tracing/concept-thorchain-vault-churn-and-asgard-migration)
