...
## Related
[CoinJoin / Mixer Detection](/kb/02-tracing/tactic-coinjoin-mixer-detection), [Exchange / VASP KYC Correlation](/kb/03-attribution-clustering/tactic-vasp-kyc-correlation), Vendor Risk Scores Disagree, and a Mixer Lowers Them
