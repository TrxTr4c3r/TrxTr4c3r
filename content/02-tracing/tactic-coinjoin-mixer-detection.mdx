...
## Related
[Taint Analysis (Taint Tracing)](/kb/02-tracing/tactic-taint-analysis) · [Transaction Graph Analysis (TGA)](/kb/02-tracing/tactic-transaction-graph-analysis) · [CoinJoin Implementation Signatures](/kb/02-tracing/tactic-coinjoin-implementation-signatures) · [Bitcoin Transaction Shape Taxonomy](/kb/00-fundamentals/framework-bitcoin-transaction-shape-taxonomy) · [Mixer-Operated Peel Chain Signatures](/kb/04-laundering-obfuscation/mixers/tactic-mixer-peel-chain-signatures)
