...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`principle`  ·  Level basics  ·  reporting · evidence · chain-of-custody · confidence-levels · court · reproducibility · methodology</span>
