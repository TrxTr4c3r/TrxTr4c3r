...
## Related
[The Three Layers of Blockchain Evidence](/kb/05-evidence-legal/framework-three-layer-blockchain-evidence-model), [The 5-Stage Investigation Process](/kb/06-casework-method/workflow-the-5-stage-investigation-process), [Wallet Clustering and Heuristics](/kb/03-attribution-clustering/concept-wallet-clustering-and-heuristics), [Crypto Investigation Glossary](/kb/00-fundamentals/definition-crypto-investigation-glossary)
