...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`framework`  ·  Level reference  ·  legal-process · vasp · kyc · subpoena · mlat · civil-discovery · law-enforcement · private-investigator · disclosure</span>
