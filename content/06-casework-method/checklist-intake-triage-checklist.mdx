...
## Related
[Five Intake Red Flags](/kb/06-casework-method/checklist-five-intake-red-flags) · [The Scope Triangle](/kb/06-casework-method/concept-the-scope-triangle) · [Five Investigation Output Types](/kb/06-casework-method/framework-five-investigation-output-types) · [Translate Stakeholder Wants into Investigable Questions](/kb/06-casework-method/tactic-translate-stakeholder-wants-into-investigable-questions) · [The First 24 Hours of a Crypto Theft](/kb/06-casework-method/checklist-first-24-hours-of-a-crypto-theft) · [Pre-Incident Recovery Readiness](/kb/06-casework-method/checklist-pre-incident-recovery-readiness)
