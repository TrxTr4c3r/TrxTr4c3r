...
3. Clustering, Group addresses controlled by one entity using the two legally tested heuristics: Common Input Ownership Heuristic (CIOH) and change address analysis. Check for address reuse. Identify and exclude CoinJoin transactions (they defeat CIOH). State explicit confidence levels (Moderate vs Confirmed, per the canonical scale).
...
## Related
[Crypto Investigation Glossary](/kb/00-fundamentals/definition-crypto-investigation-glossary) · [Wallet Clustering and Heuristics](/kb/03-attribution-clustering/concept-wallet-clustering-and-heuristics) · [Key OSINT Techniques for Crypto Investigators](/kb/01-osint/checklist-key-osint-techniques-for-crypto-investigators) · [Separate On-Chain Fact from Analytical Inference](/kb/05-evidence-legal/principle-separate-on-chain-fact-from-inference) · [Beginner Investigation Approach](/kb/06-casework-method/tactic-beginner-investigation-approach) · [The Six-Step Crypto Recovery Framework](/kb/06-casework-method/framework-six-step-crypto-recovery-framework)
