...
- Impersonation / crypto-kiosk on-ramp. A fake authority (police, tax agency, attorney, bank, corporate manager) manufactures urgency so the victim converts fiat they already hold into crypto under the scammer's control, via a crypto kiosk or a VASP account opened in the victim's name. Cash-out: the funds are already at the scammer's address the moment they leave the kiosk. Artifacts: the kiosk receipt, the deposit address, the operator's KYC and camera records (see Impersonation Scams and the Crypto-Kiosk On-Ramp).

Quick map (typology to expected cash-out): pig butchering to consolidation plus regional off-ramp or OTC; approval phishing and drainers to a kit collector plus DEX or mixer plus known exchanges; malware and key theft to an immediate full sweep; ransomware to mixer plus high-risk exchange; rug pull to LP pull plus team wallets; impersonation to a regulated on-ramp that holds records worth subpoenaing.
