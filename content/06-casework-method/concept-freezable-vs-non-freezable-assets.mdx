...
## Related
[PI Response Priority: Freeze, Monitor, Predict, OSINT](/kb/06-casework-method/framework-pi-response-priority) · [Freezing Funds with an Exchange Email](/kb/06-casework-method/tactic-exchange-freeze-email) · [Freeze Circumvention Techniques and Countermeasures](/kb/06-casework-method/checklist-freeze-circumvention-techniques-and-countermeasures)
