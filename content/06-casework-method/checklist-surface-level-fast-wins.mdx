...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`checklist`  ·  Level 2  ·  osint · explorer-metadata · label-databases · scamsniffer · chainabuse · clustering</span>
