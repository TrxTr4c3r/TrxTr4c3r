...
- Confidence tags: tag notes #confirmed / #high / #moderate / #low / #insufficient-information to track confidence throughout. One scale only, per framework-attribution-confidence-levels.
...
## Example
Creating an address note "0xabc...123" with metadata (chain: ethereum, confidence: moderate, exchange_link: Binance, tags: [suspect, layering]), wikilinking it to an "Unknown Actor A" entity note, tagging it #moderate, then viewing the cluster in Obsidian's Graph View.
