...
## Related
[PI Response Priority: Freeze, Monitor, Predict, OSINT](/kb/06-casework-method/framework-pi-response-priority) · [Freezable vs Non-Freezable Crypto Assets](/kb/06-casework-method/concept-freezable-vs-non-freezable-assets) · [Exchange Tiers and the Escalation Clock](/kb/06-casework-method/tactic-exchange-tiers-and-the-escalation-clock)
