...
<span style={{ fontFamily: 'var(--font-space-mono), monospace', fontSize: 13, opacity: 0.7 }}>`framework`  ·  Level 1  ·  crypto-investigation · asset-recovery · incident-response · private-investigator</span>
