...
## Related
[Freezing Funds with an Exchange Email](/kb/06-casework-method/tactic-exchange-freeze-email), [Monitoring Addresses with Alerts](/kb/06-casework-method/tactic-monitoring-addresses-with-alerts), [Freezable vs Non-Freezable Crypto Assets](/kb/06-casework-method/concept-freezable-vs-non-freezable-assets), [OSINT Paints the Picture on the Transaction Jigsaw](/kb/01-osint/principle-osint-paints-the-jigsaw), [The Six-Step Crypto Recovery Framework](/kb/06-casework-method/framework-six-step-crypto-recovery-framework)
